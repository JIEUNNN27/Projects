...
#%% xtxtfile
datapath = 'C:/Users/silvi/Desktop/MedicalBioResearchTopics1/12_20230519/Brain_age_estimation/' # specify the path where the 'data_regression' directory exists
machinelearningpath = os.path.join(datapath, 'machine_learning')
xtxtfile = {}
...
for i_repeat in range(option['cvrepeatnum']):
    ...
    for i_fold, (sampleidx['train'], sampleidx['test']) in enumerate(cv.split(X_train, y_train)):
        ...
        searcher = GridSearchCV(mdl, {'C': option['crange']})
